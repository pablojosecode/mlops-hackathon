...
interface PromptCompletionInput {
    prompt: string;
    model?: "openai-gpt35" | "openai-gpt4" | "palm-chat-bison" | "palm-text-bison" | "anthropic-claude-instant-v1" | "anthropic-claude-v1" | "anthropic-claude-instant-v1-100k" | "anthropic-claude-v1-100k" | "cohere-command" | "cohere-command-light";
    history?: {
        role: "user" | "ai";
        message: string;
    }[];
